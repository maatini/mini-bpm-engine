...
## Corpus Check
- 192 files · ~301,850 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1262 nodes · 3744 edges · 109 communities detected
- Extraction: 38% EXTRACTED · 62% INFERRED · 0% AMBIGUOUS · INFERRED: 2340 edges (avg confidence: 0.8)
...
Cohesion: 0.06
Nodes (180): api_post(), setup_boundary_events(), test_setup_boundary_message_event(), test_setup_boundary_no_events(), test_setup_boundary_timer_event(), complete_task_for_node(), compliance_complex_gateway_activation(), compliance_exclusive_gateway_routing() (+172 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (35): WorkflowEngine, evaluate_condition(), ProcessDefinition, groupByProcess(), WorkflowEngine, execute_complex_gateway(), execute_exclusive_gateway(), execute_inclusive_gateway() (+27 more)
...
Cohesion: 0.03
Nodes (75): api_delete(), api_get(), api_post_no_body(), api_put(), DefinitionInfo, delete_definition(), DeleteDefinitionQuery, DeployRequest (+67 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (28): NatsPersistence, parse_rhs(), test_equality(), test_numeric_comparisons(), test_parse_rhs_quoted_strings(), test_truthy(), values_cmp(), values_eq() (+20 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (61): deploy_and_start_minimal_workflow_completes_immediately(), deploy_invalid_xml_returns_400(), deploy_minimal_workflow_returns_definition_id(), start_server(), deploy_and_start(), file_variable_survives_task_completion(), file_variable_upload_creates_reference(), multiple_file_variables_and_delete_one() (+53 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (15): list_completed_instances(), main(), restore_from_nats(), shutdown_signal(), create_retry_queue(), execute_job(), PersistJob, spawn_retry_worker() (+7 more)
